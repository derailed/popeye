...
func TestBuilderYAML(t *testing.T) {
	...
	ii := linter.Issues{
		"blee": []linter.Issue{
			linter.NewError(linter.OkLevel, "Blah"),
		},
	}

	ta.Rollup(ii)
	b.AddSection("fred", ii, ta)
...
func TestPrintReport(t *testing.T) {
	...
	buff := bytes.NewBuffer([]byte(""))
	san := NewSanitizer(buff, 0, false)
	b.PrintReport(linter.OkLevel, san)
...
var reportJSON = "{\"popeye\":{\"score\":100,\"grade\":\"A\",\"sanitizers\":[{\"sanitizer\":\"fred\",\"tally\":{\"ok\":1,\"info\":0,\"warning\":0,\"error\":0,\"score\":100},\"issues\":{\"blee\":[{\"level\":0,\"message\":\"Blah\"}]}}],\"errors\":[{}]}}"
